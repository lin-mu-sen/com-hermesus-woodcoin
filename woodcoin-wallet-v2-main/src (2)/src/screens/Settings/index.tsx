      ...
      <ScrollView
        ...
        <View>
          <TouchableOpacity
            ...
            <Icon2 name="lock" size={23} color={Colors.foreground} />
          ...
          <TouchableOpacity
            ...
            <Icon3 name="world" size={24} color={Colors.foreground} />
          ...
          <TouchableOpacity
            ...
            <Icon name="reader" size={23} color={Colors.foreground} />
        ...
        <View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              openLink(
                'https://woodcoin.ru/privacy.html',
              )
            }>
            <Icon name="shield" size={23} color={Colors.foreground} />
          ...
          {/*  <TouchableOpacity
            ...
            <Icon name="layers" size={23} color={Colors.foreground} />
