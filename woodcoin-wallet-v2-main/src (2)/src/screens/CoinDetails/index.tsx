...
const CoinDetailScreen = observer(({route}:any) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      ...
      headerRight: () => (
        <View style={styles.header_place}>
          ...
          <TouchableOpacity
            ...
            <Icon name="external-link" size={32} color={Colors.foreground} />
          </TouchableOpacity>
        </View>
      ),
    });
        ...
        <View style={styles.subcont}>
          ...
          <View style={{marginRight: 15}}>
            <View
              ...
              <Text style={[styles.subTitleTop, {paddingRight: 10}]}>
                {t('coindetails.change')}
              </Text>
              <Text
                style={[
                  styles.title2,
