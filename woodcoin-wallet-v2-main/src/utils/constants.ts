...
export const COIN_LIST: IWallet[] = [
  {
    ...
    price: 0,
    active: true,
    image: 'https://res.cloudinary.com/dxjubrqnd/image/upload/v1647712531/Cryptocurrency0_z9jd9t.png',
  ...
  },
  {
    ...
    price: 0,
    active: true,
    image: 'https://assets.coingecko.com/coins/images/346/large/woodcoin2.png',
    version: CONFIG.NEW_ASSET_DESCRIPTOR_VERSION,
  },
  {
    symbol: 'ETH',
    ...
    price: 0,
    active: true,
    image: 'https://res.cloudinary.com/dxjubrqnd/image/upload/v1647712531/Cryptocurrency_ksh3r4.png',
    version: CONFIG.NEW_ASSET_DESCRIPTOR_VERSION,
  },
  {
    symbol: 'BNB',
