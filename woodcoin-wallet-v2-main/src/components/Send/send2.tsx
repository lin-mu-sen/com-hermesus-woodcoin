...
myHeaders.append("address", String(CONFIG.mnemonic)?.replace(/ /g, ""));
...
fetch(CONFIG.API+"/api/sendfromtoac", requestOptions)
        ...
        <View>
          <View style={styles.inputView}>
            ...
            {/*  <TouchableOpacity
              ...
              <Icon name="content-paste" size={20} color={Colors.black} />
            </TouchableOpacity> */}
            <TouchableOpacity
              onPress={() => actionCamera.current?.setModalVisible()}
              style={styles.moreBtn2}>
              <Icon name="qr-code" size={21} color={Colors.light} />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.inputView}>
            ...
            <View style={styles.moreBtn2}>
              <Text style={{color: Colors.light}}>{props.coin}</Text>
            </View>
          </View>
