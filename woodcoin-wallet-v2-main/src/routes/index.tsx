    ...
    <View
      ...
      <Image
        ...
        style={{
          height: 280 / 13,
          width: 279 / 13,
          tintColor: inverse ? Colors.black : '#48C57D',
          // marginLeft: 3,
        }}
      />
    </View>
...
function BottomTabs({ route, navigation }) {
  // console.log("route:", route, navigation.getState());
  // React.useEffect(() => {
  //   const unsubscribe = navigation.addListener('tabPress', (ev) => {
  //     // Prevent default behavior
  //     // e.preventDefault();
  //     console.log("prevState:", ev);
      ...
      <Tab.Navigator
        ...
        screenOptions={({ route }) => ({
          ...
          tabBarStyle: {
            ...
            // marginTop: 3,
            paddingTop: 16,
            paddingBottom: Dimensions.get("screen").height * .1 > 75 ? 75 : Dimensions.get("screen").height * .1,
            backgroundColor: Colors.darkgreen
          },
          tabBarItemStyle: {
            marginHorizontal: 20,
              ...
              return focused ? (
                ...
                >
                  <Path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M5.94 11.281c-.44.955-.44 2.042-.44 4.215v6.786c0 3.017 0 4.526.937 5.463.917.917 2.38.937 5.264.938V20.68a2.6 2.6 0 012.6-2.6h4.801a2.6 2.6 0 012.6 2.6v8.002c2.885 0 4.348-.021 5.265-.938.937-.937.937-2.446.937-5.463v-6.786c0-2.173 0-3.26-.44-4.215-.438-.955-1.263-1.661-2.913-3.076l-1.6-1.371C19.969 4.278 18.478 3 16.702 3c-1.776 0-3.267 1.278-6.249 3.834l-1.6 1.371c-1.65 1.415-2.475 2.121-2.914 3.076zm13.763 17.402V20.68a.6.6 0 00-.6-.6h-4.801a.6.6 0 00-.6.6v8.002h6z"
                    fill="#48C57D"
                  />
                </Svg>
              ) : (
