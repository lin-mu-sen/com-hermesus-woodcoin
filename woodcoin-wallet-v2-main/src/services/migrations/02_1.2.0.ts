...
export class Migration {
    ...
    if (wallets.length > 0) {
      return (
        ...
        !WalletStore.getWalletByCoinId(
          BSC_DESCRIPTOR.symbol as any,
          BSC_DESCRIPTOR.chain,
        ) ||
        !WalletStore.getWalletByCoinId(
          POLYGON_DESCRIPTOR.symbol as any,
  ...
  migrationHandler = async () => {
    ...
    if (
      ...
      wallets.splice(2, 0, {
        symbol: BSC_DESCRIPTOR.symbol?.toUpperCase() as any,
        name: BSC_DESCRIPTOR.name as any,
        cid: 'binancecoin',
        chain: BSC_DESCRIPTOR.chain,
        type: 'coin',
    ...
    if (
      ...
      wallets.splice(3, 0, {
        symbol: POLYGON_DESCRIPTOR.symbol?.toUpperCase() as any,
        name: POLYGON_DESCRIPTOR.name as any,
        cid: 'matic-network',
        chain: POLYGON_DESCRIPTOR.chain,
        type: 'coin',
