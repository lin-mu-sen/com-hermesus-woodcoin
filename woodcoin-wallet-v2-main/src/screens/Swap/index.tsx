...
const SwapScreen = props => {
  ...
  const [slippageText, setSlippageText] = useState<any>(defaultSlippage * 100); // default 0.5
  ...
  const checkPreview = async forApprove => {
    ...
    try {
      ...
      LoadingModal.instance.current?.hide();
      showMessage({
        message: e ?? t('swap.error.swap_not_found') as any,
        type: 'warning',
      });
      setStatus('preview');
    }
    ...
    return (
      <View style={styles.details}>
        ...
        <View style={styles.detailItem}>
          ...
          <Text style={{color: Colors.black}}>{slippage * 100}%</Text>
        </View>
        <View style={styles.detailItem}>
    ...
    <KeyboardAvoidingView
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          <Icon2 name="sliders" size={22} color={Colors.black} />
        </TouchableOpacity>
      </View>
      <ScrollView
        ...
        <View style={{flex: 1, justifyContent: 'space-between'}}>
          <View style={[styles.swapContainer, {}]}>
            ...
            <TouchableOpacity style={styles.connector} onPress={reverse}>
              <Icon name="swap-vertical" size={20} color={Colors.black} />
            </TouchableOpacity>
