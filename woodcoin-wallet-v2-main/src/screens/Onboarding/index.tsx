...
const Privacy = require('../../assets/svg/sec.svg').default;
const Rocket = require('../../assets/svg/rocket.svg').default;
const Finance = require('../../assets/svg/market.svg').default;
import {styles}  from './styles';
import WoodcoinIcon from 'components/icons/WoodcoinIcon';

const OnBoardingScreen = () => {
  const pw = useRef<any>(null);
