      ...
      return (
        <View>
          <TouchableOpacity
            ...
            <Icon2 name="credit-card" size={20} color={Colors.card} />
      ...
      return (
        <View>
          <TouchableOpacity
            ...
            style={styles.roundBtn2}>
            <Icon2 name="exchange" size={20} color={Colors.card} />
        ...
        <View style={styles.btnCointainers2}>
          <View>
            <TouchableOpacity
              ...
              style={styles.roundBtn2}>
              <Icon name="arrow-up" size={20} color={Colors.card} />
          ...
          <View>
            <TouchableOpacity
              ...
              style={styles.roundBtn2}>
              <Icon name="arrow-down" size={20} color={Colors.card} />
